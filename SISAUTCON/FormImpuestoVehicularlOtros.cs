...
namespace SISAUTCON
{
    public partial class FormImpuestoVehicularOtros : MetroFramework.Forms.MetroForm
    {
        LocalReport report = new LocalReport();
        EntitiesConsultas db = new EntitiesConsultas();

        public FormImpuestoVehicularOtros()
        {
            InitializeComponent();
        ...
        private void btnPrescripcion_Click(object sender, EventArgs e)
        {
            ...
            report.SetParameters(new ReportParameter("TipoRequisito", "Requisitos para Solicitar Prescripcion del Impuesto Vehicular"));
        ...
        private void btnReclamacion_Click(object sender, EventArgs e)
        {
            ...
            report.SetParameters(new ReportParameter("TipoRequisito", "Requisitos para Solicitar Reclamacion del Impuesto Vehicular"));
            report.DataSources.Add(new ReportDataSource("DataSet1", table));
            imprimir();
        }
        ...
        private void btnApelacion_Click(object sender, EventArgs e)
        {
            ...
            report.SetParameters(new ReportParameter("TipoRequisito", "Requisitos para Solicitar Apelacion del Impuesto Vehicular"));
            report.DataSources.Add(new ReportDataSource("DataSet1", table));
            imprimir();
        }
        ...
        private void btnDuplicado_Click(object sender, EventArgs e)
        {
            ...
            report.SetParameters(new ReportParameter("TipoRequisito", "Requisitos para Solicitar Duplicado del Impuesto Vehicular"));
            report.DataSources.Add(new ReportDataSource("DataSet1", table));
            imprimir();
        }
