...
namespace SISAUTCON
{
    public partial class FormEstadosCuenta : MetroFramework.Forms.MetroForm
    {
        public int nroCaracteres;

        public FormEstadosCuenta()
        {
            InitializeComponent();
        ...
        {
            FormEstadosCuentaSeleccion formEstadosCuentaSeleccion = new FormEstadosCuentaSeleccion();
            formEstadosCuentaSeleccion.FormClosed += new FormClosedEventHandler(frm2_FormClosed);
            formEstadosCuentaSeleccion.tipoImpuesto = tipoImpuesto;
            formEstadosCuentaSeleccion.Show();
        }
